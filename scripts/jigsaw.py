...
def jigsaw(imgs, rois):
    ...
    if 'face_pose' in rois_bg[0]:
        new_roi['face_pose'] = np.concatenate([x['face_pose'] for x in rois_bg], axis=0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--jigsaw_num', default=4, type=int, help='small image num in one big image')
