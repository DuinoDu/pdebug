...
def main(args):
    ...
    for imgdir in imgdirs:
        ...
        for ind, imgfile in enumerate(imgfiles):
            ...
            dstname = os.path.basename(imgfile) if args.keepname else '%08d.jpg' % (cnt)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mapping_pkl', default=None, type=str, help='output image mapping pkl')
    parser.add_argument('--link', dest='link', action='store_true', help='make soft link, instead of copy')
    parser.add_argument('--keepname', dest='keepname', action='store_true', help='keep image name')
    parser.add_argument('--output', default=None, type=str, help='output imgdir')
