...
from pdebug.pdag.io.core import (
    AbstractDataSet,
...
from pdebug.pdag.io.memory_dataset import MemoryDataSet
...
class _FrozenDatasets:
    ...
    def __init__(
        self,
        *datasets_collections: Union[
            "_FrozenDatasets", Dict[str, AbstractDataSet]
        ],
    ):
...
class DataCatalog:
    ...
    def save(self, name: str, data: Any) -> None:
        ...
        # self._logger.debug("Saving data to '%s' (%s)...", name, type(dataset).__name__)
    ...
    def __eq__(self, other):
        return (self._data_sets, self.layers) == (
            other._data_sets,
            other.layers,
        )
    ...
    def confirm(self, name: str) -> None:
        ...
        """
        # self._logger.debug("Confirming DataSet '%s'", name)
