...
def vis_human_seg(
    ...
    image_isrgb=True,
    output=None,
    tmpdir="tmp_vis_human_seg",
    loss=None,
) -> None:
    """Visualize human_seg predict and target."""
    global _COUNT
    if output:
    ...
    for batch_idx in range(batch_size):
        ...
        if pred is not None:
            ...
            vis_pred_i = draw.semseg(pred_i, image=image_i)
        ...
        if target is not None:
            ...
            vis_target_i = draw.semseg(target_i, image=image_i)
