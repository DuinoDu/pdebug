...
def histogram(
    ...
    plot(fig, filename=output, auto_open=False,
         link_text='Powered by visp', show_link=True)


def histogram2d(x, y, name=None, xlabel='x', ylabel='y', title='figure', output='index.html', **kwargs):
    """
    plot histogram2d
    """
    traces = []
    ...
    for i in range(len(y)):
        ...
        trace = go.Histogram2d(
                x=x_sorted, y=y_sorted, name=each_name,
        ...
        plot(fig, filename=output_save, auto_open=False,
             link_text='Powered by visp', show_link=True)


def lines(data, name, xlabel='x', ylabel='y', title='figure', output='index.html'):
    """
...
def line(x, y, name=None, xlabel='x', ylabel='y', title='figure', output='index.html', mode=None):
    """
    plot multi-lines data
    """
    traces = []
...
def line_thick(x, y, name=None, xlabel='x', ylabel='y', title='figure', output='index.html'):
    """
...
def CED(errs, names, normalized=False, max_value=100):
    ...
    for err in errs:
        ...
        data.append(data_i)
    lines(data, names, xlabel='error', ylabel='Images Proportion', title='CED', output='ced.html')
...
def error_curve(errs, names):
    ...
    for err in errs:
        ...
        for i in np.arange(0, 1, 0.1):
            ...
            data_i.append(error)
        data.append(data_i)
    lines(data, names, xlabel='image proportion', ylabel='error', title='分位误差', output='error.html')
